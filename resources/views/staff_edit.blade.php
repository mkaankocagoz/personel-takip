    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form action="/personel-takip/detail/staff-edit-day" method="post" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        <input type="hidden" name="edit_id" value="{{ $editDetails->id }}">
...
@section('js')
    ...
    <script>
        $('#staff_day').datetimepicker({
            format: 'DD-MM-YYYY',
            date: '{{ $editDetails->day}}'
        });
        $('#checkin').datetimepicker({
            format : 'HH:mm',
            date: '{{ $editDetails->checkin }}'
        })
        $('#checkout').datetimepicker({
            format : 'HH:mm',
            date: '{{ $editDetails->checkout }}'
        })
    </script>
